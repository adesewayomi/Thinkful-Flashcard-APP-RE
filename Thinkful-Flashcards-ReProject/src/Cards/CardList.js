    ...
    return (
        <div className="card-body border rounded p-2 my-2">
            ...
            <div className="buttons">
                <button className="btn btn-secondary mx-1" onClick={handleFlipClick}>Flip</button>
                {!flipSide && (<button className="btn btn-primary" onClick={handleNextClick}>Next</button>)}
            </div>
        </div>
    )
